...
const Profile = ({ history }) => {
  ...
  return userdetail !== null ? (
    ...
    <section className="banner-area relative" id="home">
      ...
      <form className="col-lg-8"  onSubmit={(e) => e.preventDefault() && false}>
            ...
            <div class="form-row">
              <div class="col-6 mb-30">
                ...
                <input type="email" placeholder="Official Email-id" class="form-control" value={firebase.getCurrentUsername()}
                      required />
              </div>
              </div>
              <div class="col-6 mb-30">
            ...
            <div class="form-row">
              <div class="col-6 mb-30">
                ...
                <div class="select-option" id="service-select">
                <input type="text" placeholder="City" class="form-control"  value={
