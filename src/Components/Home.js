        ...
        <div className="container">
          ...
          <div className="row align-items-center justify-content-center">
            ...
            <p className="text-white" style={{ fontSize: "17px" }}>
              Nothing is as satisfying as watching a homeless person having home
              and food. If you want to help us in providing them home, Feel free
